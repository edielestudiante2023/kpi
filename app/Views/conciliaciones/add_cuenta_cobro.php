...
<div class="container py-3">
    ...
    <form method="post" action="<?= base_url('conciliaciones/cuentas-cobro/crear') ?>" enctype="multipart/form-data" id="formCC">
        ...
        <div class="row g-3">
            <!-- COLUMNA IZQ -->
            <div class="col-md-8">
                <!-- Tercero (autocompleta los datos del cobrador y bancarios) -->
                <div class="card shadow-sm mb-3 border-info">
                    <div class="card-header bg-info text-white"><i class="bi bi-person-vcard me-1"></i>Tercero</div>
                    <div class="card-body">
                        <label class="form-label small">Seleccionar tercero (opcional)</label>
                        ...
                        <div class="text-muted small mt-1">
                            ...
                            (con RUT, cédula y cuenta bancaria) y luego selecciónalo aquí.
                        </div>
                    </div>
                </div>
...
$(function () {
    ...
    // Autocompletar datos del cobrador y bancarios al elegir un tercero
    $('#sel_tercero').on('change', function () {
        const opt = this.options[this.selectedIndex];
        if (!opt || !opt.value) return; // captura manual
        const f = document.getElementById('formCC');
