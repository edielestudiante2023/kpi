...
<head>
    ...
    <title>Editar Categoría - KPI System</title>
...
<body>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-1"><i class="bi bi-pencil me-2"></i>Editar Categoría</h1>
                <p class="text-muted mb-0">Modificar: <strong><?= esc($categoria['nombre_categoria']) ?></strong></p>
            </div>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="<?= base_url('categorias-actividad/actualizar/' . $categoria['id_categoria']) ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                $colorActual = old('color', $categoria['color']);
                                foreach ($colores as $hex => $nombre):
                                ?>
                                    <div class="color-option <?= $colorActual === $hex ? 'selected' : '' ?>"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="estado" class="form-select">
                                <option value="activa" <?= old('estado', $categoria['estado']) === 'activa' ? 'selected' : '' ?>>Activa</option>
                                <option value="inactiva" <?= old('estado', $categoria['estado']) === 'inactiva' ? 'selected' : '' ?>>Inactiva</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text"
                                   class="form-control"
                                   value="<?= date('d/m/Y H:i', strtotime($categoria['created_at'])) ?>"
                                   disabled>
                        </div>
                    </div>
