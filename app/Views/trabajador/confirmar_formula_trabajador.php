...
<head>
  <meta charset="UTF-8">
  <title>Confirmar Resultado – Kpi Cycloid</title>
...
<body class="p-4">
  ...
  <div class="container">
    ...
    <form
      action="<?= base_url('trabajador/formula/guardar/' . $indicador['id_indicador']) ?>"
      method="post">
      <?= csrf_field() ?>
      ...
      <a href="<?= base_url('trabajador/misIndicadores') ?>" class="btn btn-secondary ms-2">
        Cancelar
      </a>
    </form>
  </div>
